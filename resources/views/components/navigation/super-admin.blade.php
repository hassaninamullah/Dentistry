      ...
      <div class="flex-grow-1">
        <ul class="menu-list mt-3 rounded-4">
          ...
          <li class="brand-icon mb-3 py-1">
            ...
            <button type="button" class="btn btn-link px-0" data-bs-toggle="modal" data-bs-target="#full_screen_menu"
              data-toggle="tooltip" title="Grid Fullscreen Menu" data-bs-placement="bottom">
          ...
          <!--[ Start:: dashboard ]-->
          <li>
            <a class="m-link" href="{{route('dashboard.analytics')}}" >
          ...
          <li class="collapsed">
            <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_apps4" href="#">
              <i class='fa fa-address-book'></i>
              <span class="mx-3">Administration</span>
              <span class="arrow fa fa-angle-down ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_apps4">
              <li><a class="ms-link" href="{{route('administration.agent')}}">Agents</a></li>
              <li><a class="ms-link" href="{{route('administration.applicant')}}">Applicants</a></li>
              <li><a class="ms-link" href="{{route('administration.users')}}">System Users</a></li>
              <li><a class="ms-link" href="{{route('administration.agency')}}">Agency Profile</a></li>
            </ul>
          </li>
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu_apps">
              <li><a class="ms-link" href="{{route('client.listing')}}">Client Management</a></li>
              <li><a class="ms-link" href="{{route('client.add')}}">Add Client</a></li>
            </ul>
          </li>

          </li>
          <li class="collapsed">
            <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_apps1" href="#" >
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_apps1">
              <li><a class="ms-link" href="{{route('booking.listings')}}">Trips</a></li>
              <li><a class="ms-link" href="{{route('booking.add')}}">Add Proposals</a></li>
            </ul>
          </li>
          <li class="collapsed">
            <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_apps2" href="#" >
              <i class="fa fa-building"></i>
              <span class="mx-3">Marketing</span>
              <span class="arrow fa fa-angle-down ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_apps2">
              <li><a class="ms-link" href="{{route('marketing.email')}}" >Email Templates</a></li>
             {{-- <li><a class="ms-link" href="{{route('marketing.agency')}}" >Agency Promotion</a></li>
              <li><a class="ms-link" href="{{route('marketing.image')}}" >Images</a></li>--}}
              <li><a class="ms-link" href="{{route('marketing.supplier')}}" >Supplier Promotions</a></li>

            </ul>
          </li>
          <li>
            <a class="m-link" href="{{route('forms')}}" >
              <i class="fa fa-check-square"></i>
              <span class="mx-3">Forms</span>
            </a>
          </li>
          <li>
            <a class="m-link" href="{{route('commissions')}}" >
              <i class="fa fa-percent"></i>
              <span class="mx-3">Commissions</span>
            </a>
          </li>
          <li>
            <a class="m-link" href="{{route('suppliers')}}" >
              <i class="fa fa-industry"></i>
              <span class="mx-3">Suppliers</span>
            </a>
          </li>
          <li>
            <a class="m-link" href="{{route('reports')}}" >
              <i class="fa fa-file"></i>
              <span class="mx-3">Reports</span>
            </a>
          </li>
          {{--<li class="collapsed">
            <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu_apps3" href="#" >
              <i class="fa fa-question-circle"></i>
              <span class="mx-3">Help</span>
              <span class="arrow fa fa-angle-down ms-auto text-end"></span>
            </a>
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse" id="menu_apps3">
              <li><a class="ms-link" href="{{route('help.tutorial')}}" >Tutorials</a></li>
              <li><a class="ms-link" href="{{route('help.ticket')}}" >Tickets</a></li>
              <li><a class="ms-link" href="{{route('help.contact')}}" >Contact Us</a></li>
            </ul>
          </li>--}}
        </ul>
      </div>
