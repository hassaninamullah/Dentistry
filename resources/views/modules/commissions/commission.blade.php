...
@section('page-title', 'CRM | COMMISSIONS')
...
@section('page-content')
    ...
    <div class="page-title mb-lg-4">
        <div class="container-fluid">
            ...
            <h1 class="mb-0 text-gradient font-heading">COMMISSIONS</h1>
        </div>
    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            {{--<button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                                data-bs-target="#exampleModalLive"><i class="fa fa-plus"></i> Add Commissions</button>--}}
                        </div>
                        <div class="card-body">
                            <table class="commissions table display dataTable table-hover">
                                <thead>
                                    <tr>
                                      <th>Agent ID </th>
                                      <th>Name </th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLiveLabel">Add Commissions</h5>
...
<script type="text/javascript">
    $(function () {
      const table = $('.commissions').DataTable({
          processing: true,
          responsive:true,
          serverSide: true,
          ajax: "{{ route('commissions') }}",
          error: (error)=>{
