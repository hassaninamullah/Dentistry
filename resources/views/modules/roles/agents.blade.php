...
@section('page-content')
    ...
    <div class="page-title mb-lg-4">
      <div class="container-fluid">
        ...
        <h1 class="mb-0 text-gradient font-heading">Agents</h1>
      </div>
    </div>
          ...
          <div class="col-xxl-12 col-xl-12 col-lg-12 order-1 order-xl-0">
            <div class="card mb-4">
              <div class="card-header">
                <!-- <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModalLive"><i class="fa fa-plus"></i> Add Agents</button> -->
              </div>
              <div class="card-body">
                <table id="agent-table" class="agent-table table display table-hover">
                  <thead>
                    <tr>
                      <th>Agent ID </th>
                      <th>Name </th>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLiveLabel">Add Agents</h5>
...
<script type="text/javascript">
    $(function () {
      const table = $('.agent-table').DataTable({
          processing: true,
          responsive:true,
          serverSide: true,
          ajax: "{{ route('administration.agent') }}",
          error: (error)=>{
