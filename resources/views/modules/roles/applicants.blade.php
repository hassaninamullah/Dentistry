...
@section('page-title', 'CRM | APPLICANTS')
...
@section('page-content')
    ...
    <div class="page-title mb-lg-4">
      <div class="container-fluid">
        ...
        <h1 class="mb-0 text-gradient font-heading">Track Applicants</h1>
      </div>
    </div>
          ...
          <div class="col-xxl-12 col-xl-12 col-lg-12 order-1 order-xl-0">
            <div class="card mb-4">
              <div class="card-header">
                <!-- <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModalLive"><i class="fa fa-plus"></i> Add Track Applicants</button> -->
              </div>
              <div class="card-body">
                <table id="applicant-table" class="applicant-table table display table-hover">
                  <thead>
                    <tr>
                      <th>Name </th>
                      <th>Phone</th>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLiveLabel">Add Track Applicants</h5>
...
<script type="text/javascript">
  $(function () {
    const table = $('.applicant-table').DataTable({
        processing: true,
        responsive:true,
        serverSide: true,
        ajax: "{{ route('administration.applicant') }}",
        error: (error)=>{
