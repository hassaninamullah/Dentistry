...
@section('page-content')
    ...
    <div class="page-title mb-lg-4">
        <div class="container-fluid">
            ...
            <h1 class="mb-0 text-gradient font-heading">FORMS</h1>
        </div>
    </div>
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 order-1 order-xl-0">
                    <div class="card mb-4">
                        <div class="card-header">
                            <!-- <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModalLive"><i class="fa fa-plus"></i> New Trip</button> -->
                        </div>
                        <div class="card-body">
                            <table class="my_data_table table display dataTable table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>When will be the summer vaction trip announces?</td>
                                        <td>jacob.martin@example.com</td>
                                        <td>Enquiry</td>
                                        <td>Hi there, just wanna show my interest on coming summer vacation trip. please hit me up back when it's on</td>
                                    </tr>
                                    <tr>
                                        <td>When will be the summer vaction trip announces?</td>
                                        <td>jacob.martin@example.com</td>
